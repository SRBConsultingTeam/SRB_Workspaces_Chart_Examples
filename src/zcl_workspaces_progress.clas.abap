CLASS zcl_workspaces_progress DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS zcl_workspaces_progress IMPLEMENTATION.
  ...
  METHOD /srblp/if_mchar_content_source~retrieve_data.
    ...
    colors = VALUE #( ( |Error| ) ( |Information| ) ( |None| ) ( |Success| ) ( |Warning| ) ).
    ...
    APPEND VALUE #( linenumber = 1
                    ...
                    cmcdatadisplayvalue = COND #( WHEN value1 <= 50 THEN |start| ELSE |end| )
