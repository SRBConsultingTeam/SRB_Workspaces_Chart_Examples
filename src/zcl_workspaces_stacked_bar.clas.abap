CLASS zcl_workspaces_stacked_bar DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS zcl_workspaces_stacked_bar IMPLEMENTATION.
  ...
  METHOD /srblp/if_mchar_content_source~retrieve_data.
    ...
    APPEND VALUE #( linenumber = 1
                    ...
                    cmcdatadisplayvalue = 'A'
                    cmcdatavalue = random_value_generator->get_next( ) ) TO data.

    APPEND VALUE #( linenumber = 2
                    cmcdatacolor = get_css_color( )
                    cmcdatadisplayvalue = 'B'
                    cmcdatavalue = random_value_generator->get_next( ) ) TO data.

    APPEND VALUE #( linenumber = 3
                    cmcdatacolor = get_css_color( )
                    cmcdatadisplayvalue = 'C'
                    cmcdatavalue = random_value_generator->get_next( ) ) TO data.
